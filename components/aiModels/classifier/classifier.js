...
const CLASSES_NAME_CLOUD_ID = 'https://6169-ai-painter-7q1db-1302478925.tcb.qcloud.la/quick-draw-classifier/classes_names_zh'
...
async function loadModels() {
 ...
 // wx.cloud.init();
  wx.downloadFile({
    url: CLASSES_NAME_CLOUD_ID,
    //filePath: res.tempFilePath,
    encoding: 'utf-8',
    
    //success: res => {
      success: function(res){
        const filePsath = res.tempFilePath
        console.log(filePsath)
   ...
   // fail: err => {
  //    console.log(CLASSES_NAME_CLOUD_ID)
